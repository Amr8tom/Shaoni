...
class GetOutsideWorkingEmployeesUseCase extends UseCase<List<OutsideWorkingEmployee>, NoParams> {
  final HRServicesRepository _repository;

  GetOutsideWorkingEmployeesUseCase(this._repository);

  @override
  Future<Either<Failure, List<OutsideWorkingEmployee>>> call({required NoParams params}) async {
