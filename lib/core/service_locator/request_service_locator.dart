...
import 'package:shaoni/features/human_resources/domain/use_cases/car_permission/get_car_brands_use_case.dart';
import 'package:shaoni/features/human_resources/domain/use_cases/car_permission/get_car_colors_use_case.dart';
import 'package:shaoni/features/human_resources/domain/use_cases/complaint_request/create_complaint_request_use_case.dart';
import 'package:shaoni/features/human_resources/domain/use_cases/complaint_request/get_complaint_reasons_use_case.dart';
import 'package:shaoni/features/human_resources/domain/use_cases/complaint_request/get_complaint_types_use_case.dart';
import 'package:shaoni/features/human_resources/presentation/controller/car_permission/car_permission_cubit.dart';
...
import '../../features/human_resources/domain/use_cases/car_permission/create_car_permission_use_case.dart';
import '../../features/human_resources/domain/use_cases/car_permission/update_car_permission_use_case.dart';
import '../../features/human_resources/domain/use_cases/attendance/update_attendance_use_case.dart';
import '../../features/human_resources/domain/use_cases/exit/create_exit_permission_use_case.dart';
import '../../features/human_resources/domain/use_cases/exit/update_exit_permission_use_case.dart';
import '../../features/human_resources/domain/use_cases/exit/get_permission_time_use_case.dart';
import '../../features/human_resources/domain/use_cases/exit/get_permission_types_use_case.dart';
import '../../features/human_resources/presentation/controller/attendance/attendance_cubit.dart';
...
import '../../features/human_resources/domain/use_cases/experience_certificate/get_certificate_reasons_use_case.dart';
import '../../features/human_resources/domain/use_cases/experience_certificate/create_experience_certificate_use_case.dart';
import '../../features/human_resources/domain/use_cases/experience_certificate/update_experience_certificate_use_case.dart';
import '../../features/human_resources/presentation/controller/experience_certificate/experience_certificate_cubit.dart';
import '../../features/human_resources/domain/use_cases/id_document/get_countries_use_case.dart';
import '../../features/human_resources/domain/use_cases/id_document/get_id_renewal_request_types_use_case.dart';
import '../../features/human_resources/domain/use_cases/id_document/create_id_document_use_case.dart';
import '../../features/human_resources/presentation/controller/id_document/id_document_cubit.dart';
import '../../features/human_resources/domain/use_cases/medical_insurance/get_medical_insurance_classes_use_case.dart';
import '../../features/human_resources/domain/use_cases/medical_insurance/get_employee_relatives_use_case.dart';
import '../../features/human_resources/domain/use_cases/medical_insurance/create_medical_insurance_use_case.dart';
import '../../features/human_resources/domain/use_cases/medical_insurance/update_medical_insurance_use_case.dart';
import '../../features/human_resources/presentation/controller/medical_insurance/medical_insurance_cubit.dart';
import '../../features/human_resources/domain/use_cases/product_order/get_product_categories_use_case.dart';
import '../../features/human_resources/domain/use_cases/product_order/get_products_by_category_use_case.dart';
